...
>>>>>>> 7632aa9e9ff06bd3d4ee7094ef2617255c4e04a3
        ...
        if 'Temporada' in df_ventas.columns:
            ...
            def vendido_fuera_temporada(row):
                ...
                if tipo_temporada == 'I':  # Invierno: sept (año-1) a feb (año)
                    ...
                    # Verificar si la fecha está dentro del período de invierno
                    if inicio <= fecha <= fin:
                    ...
                    # Verificar si la fecha está dentro del período de verano
                    if inicio <= fecha <= fin:
...
# Robust column name handling function
